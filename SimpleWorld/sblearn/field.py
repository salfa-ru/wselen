...
from .action_library import count_b1
...
class Field(object): # создание поля мира
    ...
    def insert_object(self, x, y, entity_object, epoch_shift=0):#создание нового объекта
    ...
    def remove_object(self, entity_object, x=None, y=None): #удаление объекта с поля
    ...
    def find_all_coordinates_by_type(self, type_to_find):# находим координаты всех сущностей по типам
        field = self.__field
    ...
    def find_all_entities_by_type(self, type_to_find): # находим все сущности по типам
        field = self.__field
    ...
    def make_path(self, x1, y1, x2, y2): # построение траектории движения
