...
def visualize(field):
    ...
    pygame.display.set_caption("SimpleWorld")  # Пишем в шапку
    ...
    while go_on:  # Основной цикл программы
        ...
        label = myfont.render("Появилось: "+str(f.countb()), 1, (255, 255, 0))
        screen.blit(label, (630, 70 ))

        label = myfont.render("Исчезло: "+str(f.countd()), 1, (255, 255, 0))

        screen.blit(label, (630, 85 ))


        #for i, element in enumerate(stats):
        #    label = myfont.render("Энергии".ent, 1, (255, 255, 0))
        #    screen.blit(label, (630, 75 + (i * 15)))
