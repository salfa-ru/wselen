...
def num_substance(entity):
    print(entity.count_substance_of_type(substances.Substance))
    ...
    def handle_creation(self, creation, refuse):
        if isinstance(creation, entities.Creature):
            ...
            if creation.sex:
                ...
                #self.count_substance_of_type(substances.Substance)
...
universe.populate(entities.Creature, 1)  # Populate universe with creatures
